...
import { logKeysAtom, parsedLogsMapAtom, activeTabAtom } from "@renderer/lib/atom";
...
function RouteComponent() {
  ...
  return (
    <div className="w-full h-[calc(100vh-100px)] scrollbar-container overflow-hidden p-4">
      <Tabs value={activeTab || logKeys[0]} onValueChange={setActiveTab} orientation="vertical">
